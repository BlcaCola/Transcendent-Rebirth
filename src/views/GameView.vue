...
import { X, Package, User, Brain, Users, BookOpen, Zap, Settings, Save, Map, Scroll, Bell, Home, Box, Users2, Database, RefreshCw, FlaskConical, Trash2, BarChart3, Coins, FileText, Plug } from 'lucide-vue-next';
...
const applySettings = () => {
  try {
    ...
    if (savedSettings) {
      ...
      document.documentElement.setAttribute('data-theme', 'dark');
      localStorage.setItem('dad_game_settings', JSON.stringify({ theme: 'dark' }));
    }
  } catch (error) {
